...
TContainer(id="menu", sizeX="0.8", sizeY="0.8", posX="0.1", posY="0.1", title="Main Menu", drawOutline="0", startHidden="0")
	TButton(id="startGame", sizeX="0.2", sizeY="0.1", posX="0.4", posY="0.6", text="Start Game", texture="Resources/Images/button.png", clickSound="Resources/Audio/click.wav", hoverSound="Resources/Audio/hover.wav")
	TButton(id="settingsButton", sizeX="0.2", sizeY="0.1", posX="0.4", posY="0.45", text="Settings", texture="Resources/Images/button.png", clickSound="Resources/Audio/click.wav", hoverSound="Resources/Audio/hover.wav")
	TButton(id="exitGame", sizeX="0.2", sizeY="0.1", posX="0.4", posY="0.30", text="Exit", texture="Resources/Images/button.png", clickSound="Resources/Audio/click.wav", hoverSound="Resources/Audio/hover.wav")
